...
|----------|-----------|---------|
| MVP tập trung vào hiển thị danh mục sản phẩm | Ưu tiên cốt lõi: trưng bày sản phẩm là chức năng chính | — Pending |
| Dùng lại template-frontend làm giao diện Blade | Tiết kiệm thời gian thiết kế, tận dụng layout có sẵn | — Pending |
| Tiếng Việt trước, thêm tiếng Anh sau | Đơn giản hóa MVP, kiến trúc sẵn sàng cho i18n | — Pending |
| Chủ doanh nghiệp tự quản trị | Admin panel thân thiện, không cần phân quyền phức tạp | — Pending |
